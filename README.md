...
A. For sync between two folders on the same device:
  1. Open a terminal window and navigate to the folder where you want to set up the client folder (Folder 1)
